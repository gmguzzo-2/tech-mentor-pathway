        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            <div className="flex items-center mb-4">
              ...
              <span className="text-gray-600 uppercase tracking-wider text-sm font-medium">Tech Learning Platform</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Accelerate Your <span className="gradient-text">Tech Career</span> with Personalized Learning
            </h1>
            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-xl">
              Connect with expert mentors, access curated courses, and build the skills you need for success in the tech industry.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 mt-12">
              <div className="text-center">
                ...
                <div className="text-gray-500 text-sm mt-1">Curated Courses</div>
              </div>
              <div className="text-center">
                <div className="font-bold text-3xl text-techpurple">120+</div>
                <div className="text-gray-500 text-sm mt-1">Expert Mentors</div>
              </div>
              <div className="text-center">
          ...
          <div className="relative">
            <div className="relative z-10 rounded-xl bg-white shadow-xl p-6 md:p-8 animate-float">
              ...
              <h3 className="text-lg font-bold mb-4">Web Development Pathway</h3>
              <div className="flex items-center mb-4">
              ...
              <div className="space-y-3 mb-4">
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-600">6 months pathway</span>
                </div>
                <div className="flex items-center">
                  <BookOpen className="text-gray-400 h-4 w-4 mr-2" />
                  <span className="text-sm text-gray-600">12 courses included</span>
                </div>
                <div className="flex items-center">
                  <Award className="text-gray-400 h-4 w-4 mr-2" />
                  <span className="text-sm text-gray-600">Industry-recognized certificate</span>
                </div>
              </div>
              ...
              <Button className="w-full bg-techblue hover:bg-techblue/90">View Pathway</Button>
            </div>
